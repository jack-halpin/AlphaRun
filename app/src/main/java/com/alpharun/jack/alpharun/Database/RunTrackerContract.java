...
public class RunTrackerContract {
    ...
    public static class LocationEntry implements BaseColumns{
        ...
        public static final String RELATIVE_DISTANCE = "rel_distance";
        public static final String CURRENT_PACE = "curr_pace";
        public static final String TIMESTAMP_SEC = "timestamp_seconds";
